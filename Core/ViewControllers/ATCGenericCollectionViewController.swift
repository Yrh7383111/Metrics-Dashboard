...
extension ATCGenericCollectionViewControllerDataSourceDelegate where Self: ATCGenericCollectionViewController {
    func genericCollectionViewControllerDataSource(_ dataSource: ATCGenericCollectionViewControllerDataSource, didLoadFirst objects: [ATCGenericBaseModel], completionHandler: @escaping (() -> Void)) {
        self.reloadCollectionView(completionHandler)
    }
}
...
class ATCGenericCollectionViewController: UICollectionViewController, ATCGenericCollectionViewControllerDataSourceDelegate {
    ...
    fileprivate func reloadCollectionView(_ completionHandler: (() -> Void)? = nil) {
        ...
        self.updateAfterLoad(completionHandler)
    }

    private func updateAfterLoad(_ completionHandler: (() -> Void)? = nil) {
...
extension ATCGenericCollectionViewController {
    override func scrollViewDidEndDecelerating(_ scrollView: UIScrollView) {
        ...
        scrollDelegate?.genericScrollViewDidScroll(scrollView)
    }
