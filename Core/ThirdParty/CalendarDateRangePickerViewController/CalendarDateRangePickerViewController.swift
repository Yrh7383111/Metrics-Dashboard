...
public class CalendarDateRangePickerViewController: UICollectionViewController {
    ...
    override public func viewDidLoad() {
        ...
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Cancel".localizedCore, style: .plain, target: self, action: #selector(CalendarDateRangePickerViewController.didTapCancel))
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Done".localizedCore, style: .done, target: self, action: #selector(CalendarDateRangePickerViewController.didTapDone))
